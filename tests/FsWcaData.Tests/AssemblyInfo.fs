...
[<assembly: AssemblyTitleAttribute("FsWcaData.Tests")>]
[<assembly: AssemblyProductAttribute("FsWcaData")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FsWcaData.Tests"
    let [<Literal>] AssemblyProduct = "FsWcaData"
